...
public class JSONTesting : MonoBehaviour
{
    ...
    public void GenerateJSON()
    {
        ...
        stage1.dataList.Add(new UnitIndividualData(0, 2));
        stage1.dataList.Add(new UnitIndividualData(0, 2));
        stage1.dataList.Add(new UnitIndividualData(0, 2));
        stage1.dataList.Add(new UnitIndividualData(0, 2));
        ...
        stage2.dataList.Add(new UnitIndividualData(1, 4));
        stage2.dataList.Add(new UnitIndividualData(1, 4));
        stage2.dataList.Add(new UnitIndividualData(1, 4));
        stage2.dataList.Add(new UnitIndividualData(1, 4));
        ...
        stage3.dataList.Add(new UnitIndividualData(2, 6));
        stage3.dataList.Add(new UnitIndividualData(2, 6));
        stage3.dataList.Add(new UnitIndividualData(2, 6));
        stage3.dataList.Add(new UnitIndividualData(2, 6));
        ...
        stage4.dataList.Add(new UnitIndividualData(1, 15));
        stage4.dataList.Add(new UnitIndividualData(0, 5));
        stage4.positionList.Add(31);
        stage4.positionList.Add(36);
        stageData.stageDataList.Add(stage4);

        PrimitiveTeamData stage5 = new PrimitiveTeamData();
        stage5.dataList.Add(new UnitIndividualData(3, 10));
        stage5.dataList.Add(new UnitIndividualData(3, 10));
        stage5.dataList.Add(new UnitIndividualData(3, 10));
        stage5.dataList.Add(new UnitIndividualData(3, 10));
        ...
        PlayerData playerData = new PlayerData(0, 10, 10, 10, System.DateTime.UtcNow.ToString(), 0, 0, -1);
