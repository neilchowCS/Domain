...
public class StatusFramework : BattleObject, IBattleStatus
{
    ...
    public StatusFramework(BattleExecutor exec, int side, string name, IBattleObject source,
        IBattleUnit host, StatusType sType) : base(exec, BattleObjectType.Status, side, name)
    {
        Host = host;
        Source = source;
        hasDuration = false;
    ...
    public StatusFramework(BattleExecutor exec, int side, string name, IBattleObject source,
        IBattleUnit host, StatusType sType, int duration) : base(exec, BattleObjectType.Status, side, name)
    {
        Host = host;
        Source = source;
        hasDuration = true;
    ...
    //HANDLE STATUS REMOVAL ELSEWHERE
