...
public class HealthBar : MonoBehaviour
{
    ...
    void LateUpdate()
    {
        ...
        {
            healthFill.fillAmount = parent.currentHealth / (float)parent.unitData.unitHealth;
            manaFill.fillAmount = parent.currentMana / (float)parent.unitData.unitMaxMana.Value;
